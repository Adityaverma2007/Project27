...
function setup() {
	...
	bob6 = new bob(425,575,40);
	bob7 = new bob(440,575,40);
	
	rope1=new rope(bob1.body,roofObject.body,-80, 0);
	rope2=new rope(bob2.body,roofObject.body,-40, 0);
	rope3=new rope(bob3.body,roofObject.body,-112,0);
	rope4=new rope(bob4.body,roofObject.body,-0,0);
	rope5=new rope(bob5.body,roofObject.body,30,0);
	rope6=new rope(bob6.body,roofObject.body,50,0);
	rope7=new rope(bob7.body,roofObject.body,80,0);
